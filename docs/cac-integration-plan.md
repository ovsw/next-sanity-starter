...
| Studio media fixes and simpler link fields | Main agent | Implemented | Media 6.3.0 and tag-icon patch installed; schema extraction and Studio build passed; stored destination shapes preserved |
