...
export const customLinkInternalHref = groq`select(
  ...
  customLink.internal->_type == "post" && defined(customLink.internal->slug.current) => "/blog/" + customLink.internal->slug.current,
...
export const urlInternalHref = groq`select(
  ...
  url.internal->_type == "post" && defined(url.internal->slug.current) => "/blog/" + url.internal->slug.current,
...
export const legacyInternalLinkHref = groq`select(
  ...
  @.internalLink->_type == "post" && defined(@.internalLink->slug.current) => "/blog/" + @.internalLink->slug.current,
