...
export const redirectDestinationPath = groq`select(
  ...
  destinationReference->_type == "post" && defined(destinationReference->slug.current) => "/blog/" + destinationReference->slug.current,
  ...
  destinationReference->_type == "page" && string::startsWith(destinationReference->slug.current, "/") => destinationReference->slug.current,
  destinationReference->_type == "page" && defined(destinationReference->slug.current) => "/" + destinationReference->slug.current
)`;
